...
**This is the Windows Only Guide - for other platforms, see: [README] (README.md)**

*Currently supporting most Windows systems with more or less native notifications*
...
**Install notifu, sounder.exe and colorama**
...
Download and install Growl for [Windows] [3]

Download and install GNTP for your system. For Windows this is a bit bothersome, but I've managed to do it by doing the following:
...
- Now we just need to install gntp through pip, enter this command in a command prompt opened as Administrator.
...
Here you may specify a color to use for all the console output. Replace COLOR with one of the following values: **black**, **gray**, **white**, **red**, **green**, **yellow**, **blue**, **magenta**, **cyan** and last but not least **rainbow**. *You will need to install colorama for this one to work, see information above*
...
- **SUBTITLE** - The subtitle to display in the notification - This is intended for Mac OS Native Notifications - If entered in a Windows system, it will be appended to the title

- **MESSAGE** - The text to display in the notification

- **TIME** - If entered, the notification will be requested to be removed after this amount of milliseconds. Only for notifications with notifu, not Growl.

- **SOUND** - The sound to play when the notification is shown. This application have integrated support with [sounder.exe] [6], and the sounds have to be written with the full path.
...
Please note that I've only tested this on a limited set of systems and combinations. If you want support for more systems or features, please ask and I might be able to help out. Known working combinations with Windows are:
